...
<table class="simple_cpt">
    ...
    <tr>
        <td class="first">
            ...
            <input type="text" name="simple_cpt_custom_rewrite_slug" id="simple_cpt_custom_rewrite_slug" class="widefat" tabindex="8" value="<?php echo $simple_cpt_custom_rewrite_slug; ?>" />
            <p><?php _e( 'Customize the permalink slug.', 'simple-cpt' ); ?></p>
        </td>
        <td>
            <label for="simple_cpt_description"><?php _e( 'Description', 'simple-cpt' ); ?></label>
            <textarea name="simple_cpt_description" id="simple_cpt_description" class="widefat" tabindex="4" rows="4"><?php echo $simple_cpt_description; ?></textarea>
    ...
    <tr>
        <td class="first">
            ...
            <select name="simple_cpt_public" id="simple_cpt_public" tabindex="5">
        ...
        <td>           
            ...
            <select name="simple_cpt_has_archive" id="simple_cpt_has_archive" tabindex="12">
    ...
    <tr>
        <td class="first">
            ...
            <select name="simple_cpt_exclude_from_search" id="simple_cpt_exclude_from_search" tabindex="11">
        ...
        <td>
            ...
            <select name="simple_cpt_show_ui" id="simple_cpt_show_ui" tabindex="13">
    ...
    <tr>
        <td class="first">
            ...
            <select name="simple_cpt_show_in_menu" id="simple_cpt_show_in_menu" tabindex="15">
        ...
        <td>
            ...
            <input type="text" name="simple_cpt_menu_position" id="simple_cpt_menu_position" class="widefat" tabindex="14" value="<?php echo $simple_cpt_menu_position; ?>" />
    ...
    <tr>
        <td class="first">
            ...
            <input type="text" name="simple_cpt_icon_slug" id="simple_cpt_icon_slug" class="widefat" tabindex="18" value="<?php echo $simple_cpt_icon_slug; ?>" />
        ...
        <td>
            ...
            <select name="simple_cpt_publicly_queryable" id="simple_cpt_publicly_queryable" tabindex="22">
    ...
    <tr>
        <td class="first">
            ...
            <select name="simple_cpt_feeds" id="simple_cpt_feeds" tabindex="9">
        ...
        <td>
            ...
            <select name="simple_cpt_pages" id="simple_cpt_pages" tabindex="10">
    ...
    <tr>
        <td class="first">
            ...
            <select name="simple_cpt_show_in_rest" id="simple_cpt_show_in_rest" tabindex="21">
        ...
        <td>
            ...
            <select name="simple_cpt_query_var" id="simple_cpt_query_var" tabindex="20">
    ...
    <tr>
        <td class="first">
            ...
            <input type="checkbox" tabindex="23" name="simple_cpt_supports[]" id="simple_cpt_supports_title" value="title" <?php checked( $simple_cpt_supports_title, 'title' ); ?> /> <label class="checkbox" for="simple_cpt_supports_title"><?php _e( 'Title', 'simple-cpt' ); ?> <span class="default">(<?php _e( 'default', 'simple-cpt' ); ?>)</span></label><br />
            <input type="checkbox" tabindex="24" name="simple_cpt_supports[]" id="simple_cpt_supports_editor" value="editor" <?php checked( $simple_cpt_supports_editor, 'editor' ); ?> /> <label class="checkbox" for="simple_cpt_supports_editor"><?php _e( 'Editor', 'simple-cpt' ); ?> <span class="default">(<?php _e( 'default', 'simple-cpt' ); ?>)</span></label><br />
            <input type="checkbox" tabindex="25" name="simple_cpt_supports[]" id="simple_cpt_supports_excerpt" value="excerpt" <?php checked( $simple_cpt_supports_excerpt, 'excerpt' ); ?> /> <label class="checkbox" for="simple_cpt_supports_excerpt"><?php _e( 'Excerpt', 'simple-cpt' ); ?> <span class="default">(<?php _e( 'default', 'simple-cpt' ); ?>)</span></label><br />
            <input type="checkbox" tabindex="26" name="simple_cpt_supports[]" id="simple_cpt_supports_trackbacks" value="trackbacks" <?php checked( $simple_cpt_supports_trackbacks, 'trackbacks' ); ?> /> <label class="checkbox" for="simple_cpt_supports_trackbacks"><?php _e( 'Trackbacks', 'simple-cpt' ); ?></label><br />
            <input type="checkbox" tabindex="27" name="simple_cpt_supports[]" id="simple_cpt_supports_custom_fields" value="custom-fields" <?php checked( $simple_cpt_supports_custom_fields, 'custom-fields' ); ?> /> <label class="checkbox" for="simple_cpt_supports_custom_fields"><?php _e( 'Custom Fields', 'simple-cpt' ); ?></label><br />
            <input type="checkbox" tabindex="28" name="simple_cpt_supports[]" id="simple_cpt_supports_comments" value="comments" <?php checked( $simple_cpt_supports_comments, 'comments' ); ?> /> <label class="checkbox" for="simple_cpt_supports_comments"><?php _e( 'Comments', 'simple-cpt' ); ?></label><br />
            <input type="checkbox" tabindex="29" name="simple_cpt_supports[]" id="simple_cpt_supports_revisions" value="revisions" <?php checked( $simple_cpt_supports_revisions, 'revisions' ); ?> /> <label class="checkbox" for="simple_cpt_supports_revisions"><?php _e( 'Revisions', 'simple-cpt' ); ?></label><br />
            <input type="checkbox" tabindex="30" name="simple_cpt_supports[]" id="simple_cpt_supports_featured_image" value="thumbnail" <?php checked( $simple_cpt_supports_featured_image, 'thumbnail' ); ?> /> <label class="checkbox" for="simple_cpt_supports_featured_image"><?php _e( 'Featured Image', 'simple-cpt' ); ?></label><br />
            <input type="checkbox" tabindex="31" name="simple_cpt_supports[]" id="simple_cpt_supports_author" value="author" <?php checked( $simple_cpt_supports_author, 'author' ); ?> /> <label class="checkbox" for="simple_cpt_supports_author"><?php _e( 'Author', 'simple-cpt' ); ?></label><br />
            <input type="checkbox" tabindex="32" name="simple_cpt_supports[]" id="simple_cpt_supports_page_attributes" value="page-attributes" <?php checked( $simple_cpt_supports_page_attributes, 'page-attributes' ); ?> /> <label class="checkbox" for="simple_cpt_supports_page_attributes"><?php _e( 'Page Attributes', 'simple-cpt' ); ?></label><br />
            <input type="checkbox" tabindex="33" name="simple_cpt_supports[]" id="simple_cpt_supports_post_formats" value="post-formats" <?php checked( $simple_cpt_supports_post_formats, 'post-formats' ); ?> /> <label class="checkbox" for="simple_cpt_supports_post_formats"><?php _e( 'Post Formats', 'simple-cpt' ); ?></label><br />
        </td>
        <td>
            ...
            <input type="checkbox" tabindex="34" name="simple_cpt_builtin_tax[]" id="simple_cpt_builtin_tax_categories" value="category" <?php checked( $simple_cpt_builtin_tax_categories, 'category' ); ?> /> <label class="checkbox" for="simple_cpt_builtin_tax_categories"><?php _e( 'Categories', 'simple-cpt' ); ?></label><br />
            <input type="checkbox" tabindex="35" name="simple_cpt_builtin_tax[]" id="simple_cpt_builtin_tax_tags" value="post_tag" <?php checked( $simple_cpt_builtin_tax_tags, 'post_tag' ); ?> /> <label class="checkbox" for="simple_cpt_builtin_tax_tags"><?php _e( 'Tags', 'simple-cpt' ); ?></label><br />
        </td>
    </tr>
</table>
